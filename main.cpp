...
class Odin {
 ...
 private:
  ...
  void copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
    ...
    VkCommandBufferBeginInfo beginInfo = {};
    beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
    // Good practice to let driver know about these one-time copies
    ...
    // TODO Add a fence here instead of idling in order to be able to submit
    // multiple queues and give the driver a chance to optimize

...
class App {
 ...
 private:
  ...
  //
  //    if (vkCreateImage(deviceManager->getLogicalDevice(), &imageInfo,
  //    nullptr,
  //                      &image) != VK_SUCCESS) {
  ...
  //
  //    if (vkAllocateMemory(deviceManager->getLogicalDevice(), &allocInfo,
  //    nullptr,
  //                         &imageMemory) != VK_SUCCESS) {
  //      throw std::runtime_error("failed to allocate image memory!");
  //    }
  //
  //    vkBindImageMemory(deviceManager->getLogicalDevice(), image, imageMemory,
  //    0);
  //  }
  ...
  void createTextureImage() {
    ...
    //  vkDestroyBuffer(deviceManager->getLogicalDevice(), stagingBuffer,
    //  nullptr); vkFreeMemory(deviceManager->getLogicalDevice(),
    //  stagingBufferMemory,
    //               nullptr);
